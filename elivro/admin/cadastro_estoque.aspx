<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cadastro_estoque.aspx.cs" Inherits="elivro.admin.cadastro_estoque" %>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <form action="#" method="post">
                                <div class="row">
                                    <div class="col-12 mb-3">                                         
                                        ...
                                        <select class="w-100" id="Livro">
                                        <option value="livro1">Livro 1</option>
                                        <option value="livro2">Livro 2</option>
                                    </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="number" class="form-control" id="quantidade" value="" placeholder="Quantidade" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="form-control" id="custo" value="" placeholder="Custo" required>
                                    </div>
                                    <div class="col-12 mb-3">                                         
                                           <h5>Selecione o grupo de precificação:</h5>
                                        <select class="w-100" id="precificacao">
                                        <option value="grupo1">Grupo 1</option>
                                        <option value="grupo2">Grupo 2</option>
                                    </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="form-control" id="fornecedor" placeholder="Fornecedor" value="">
                                    </div>
                                    ...
                                    <div class="create-btn mt-50">
                                      <a href="lista_estoque.aspx" class="btn btn-primary fa-pull-right">Salvar</a>
                                    </div>
                                </div>
                                </form>
