<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="alterar_cliente.aspx.cs" Inherits="elivro.admin.alterar_cliente" %>
                            ...
                            <form action="#" method="post">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="form-control" id="first_name" value="" placeholder="Nome" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="form-control" id="last_name" value="" placeholder="Sobrenome" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <input type="date" class="form-control" id="date" placeholder="Data de Nascimento" value="">
                                    </div>

                                     <div class="col-12 mb-3">
                                        <select class="w-100" id="Gênero">
                                    ...
                                    <div class="col-12 mb-3">
                                        <input type="tel" class="form-control" id="password" placeholder="Senha" value="">
                                    </div>
                                </div>
                            <form action="#" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        <input type="text" class="form-control" id="adress_name" placeholder="Nome Endereço" value="">
                                    </div>
                                    <div class="col-12 mb-3">
                                        <input type="text" class="form-control" id="name" placeholder="Nome Destinatário" value="">
                                    </div>
                                    <div class="col-12 mb-3">
                                        <select class="w-100" id="tipo_residencia">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <select class="w-100" id="tipo_logradouro">
                                    ...
                                    <div class="col-md-9 mb-3">
                                        <input type="text" class="form-control mb-3" id="logradouro" placeholder="Logradouro" value="">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-12 mb-3">
                                        <input type="text" class="form-control" id="estado" placeholder="Estado" value="">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="form-control" id="cep" placeholder="CEP" value="">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="form-control" id="complemento" placeholder="Complemento" value="">
                                    </div>
                                    <div class="create-btn mt-50">
                                      <a href="lista_clientes.aspx" class="btn btn-primary fa-pull-right">Salvar</a>
                                    </div>
                                </div>
                            </form>
                        </div>
