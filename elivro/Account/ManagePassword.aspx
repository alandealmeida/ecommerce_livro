<%@ Page Title="Gerenciar senha" Language="C#" MasterPageFile="~/store/Store.Master" AutoEventWireup="true" CodeBehind="ManagePassword.aspx.cs" Inherits="elivro.Account.ManagePassword" %>
                        ...
                        local para que fazer logon sem um logon externo.
                            ...
                            <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-2 col-md-10">
                                            <asp:Button runat="server" Text="Alterar senha" ValidationGroup="ChangePassword" OnClick="ChangePassword_Click" CssClass="btn amado-btn w-100" />
                                        </div>
                                    </div>
                                </div>
                            </asp:PlaceHolder>
